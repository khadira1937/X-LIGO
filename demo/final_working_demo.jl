...
"""
X-LiGo DeFi Protection System - FINAL WORKING DEMO
Inline function definitions to avoid scope issues
"""
...
# Try to load OpenAI, install if needed
try
    using OpenAI
    global HAS_OPENAI = true
catch e
    @warn "OpenAI package not available, using fallback" error=e
    global HAS_OPENAI = false
end
...
function print_header()
    println("🚀" * "="^70 * "🚀")
    println("🛡️  X-LiGo DeFi Protection System - FINAL WORKING DEMO  🛡️")
    println("🚀" * "="^70 * "🚀")
    println()
...
function print_welcome()
    ...
    println()
    println("🛡️  Your Personal DeFi Security Assistant with Working AI")
    println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    println()
            ...
            HTTP.serve("0.0.0.0", 3000) do request::HTTP.Request
                if request.method == "POST" && request.target == "/chat"
                    try
                        ...
                        # INLINE AI RESPONSE FUNCTION (avoiding scope issues)
                        function server_ai_response(msg::String)
...
function interactive_chat()
    ...
    println("💬" * "="^50 * "💬")
    println("💬  AI SECURITY CHAT (WORKING VERSION)")
    println("💬" * "="^50 * "💬")
    println()
    ...
    while true
        ...
        # INLINE AI RESPONSE FUNCTION (this will work because it's local scope)
        function chat_ai_response(msg::String)
            user_id = demo_state.user_id
            monitoring_active = demo_state.monitoring_active
        ...
        # This should work because the function is defined in local scope
        try
            ai_response = chat_ai_response(message)
            println(ai_response)
        catch e
            println("❌ Error generating response: $e")
            println("\n🔄 **Simple Response:** Hello! I'm your AI assistant. I can help with security analysis and general questions. Try asking about attacks, the World Cup, or how I'm doing!")
        end
...
function show_system_status()
    ...
    if demo_state.user_id !== nothing
        ...
        println("🤖 AI Engine: ✅ Working (Inline Functions)")
...
function show_menu()
    ...
    println("   5️⃣  Interactive Security Chat (WORKING!)")
